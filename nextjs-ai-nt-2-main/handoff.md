...
## งานค้าง / โน้ต
- UI component test ครอบคลุมเพียบ (Lightbox, SecurityForm, LogoutMenu, Navbar, CustomersClient, AdminClient, EngineeringClient, LocationsClient, RoomsClient, FloorplanClient, ProfileClient + server actions ของ admin/engineering/locations/profile) — suite รวม 23 ไฟล์ / 241 เทสต์ ✓
